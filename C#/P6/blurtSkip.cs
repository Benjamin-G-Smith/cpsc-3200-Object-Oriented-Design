...
// 5. The blurtSkip class uses a has a relationship with a blurtRep object,
//      echoing the functionality of the blurtRep to get desired functionality


namespace P6
{
    class blurtSkip: skipGen
    {
        ...
        public blurtSkip(string blurtW, uint a1 = 1, uint d = 3, uint n = 20) : base(a1, d, n)
        {
            // precondition all variables are valid
            active = true;
            calculatedValue = 0;
